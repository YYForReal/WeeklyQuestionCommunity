<template lang="">
  <div>
        <video src="@/assets/xiyou.mp4" style="width:100%" preload controls ></video>
...
export default {
  data() {
    return {
      // dialogVisible: true,
      // src: "https://om.tc.qq.com/gzc_1000102_0b53qeaaeaaaguab567utbq4baodakgqabsa.f2.mp4?vkey=",
      // videos: [
      //   {
